...
class Main {
  public static void main(String[] args) {
    ...
    Cars car1 = new Cars("Red", 32);//Create car object
    garage.add(car1);//add it to the list
    garage.add(new Cars("Blue", 42));//both done in one line

    for (int i = 0; i < garage.size(); i++) {
      Cars temp = garage.get(i);
      System.out.println(temp);//Runs the toString method
    }
